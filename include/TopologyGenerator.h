...
class TopologyGenerator 
{
    ...
    public:
        TopologyGenerator();
        Network* generate_mono_random_topology(map<string, string> parameters);
        void generate_mono_random_graph(string gen_type, int rand_seed, int nb_nodes, int m_attach, int p_attach, int c_prob);
        ...
        void write_topology(Network* network, string file_name); 
        ~TopologyGenerator();
};
