...
class IGraphGenerator
{
	public:
		...
		virtual void generate_barabasi_albert_graph(int rand_seed, BAGen type, int n, float p, int m, const igraph_vector_t *outseq,
					                                 int outpref, float A, int directed, const igraph_t *start_from) = 0;
